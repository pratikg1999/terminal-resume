  ...
  render() {
    return (
      <div className="App">
        ...
        <div className="new" onClick={(e)=>{console.log("cliked", e);this.newInpRef.current.focus();}}>
          <div className="left-prompts" onClick={(e)=>e.stopPropagation()}>
            <span className="username" style={{ color: this.state.userSysColor }}>{this.state.username}@</span>
            <span className="system" style={{ color: this.state.userSysColor }}>{this.state.system}</span>
            <span>:</span>
          ...
          <span id="new-inp" ref={this.newInpRef} contentEditable="true" onKeyUp={(e) => {
            if (e.key === "Enter") {
